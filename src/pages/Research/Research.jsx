  ...
  const renderCards = () => {
    switch (selectedTab) {
      case "JOURNAL PUBLICATIONS":
        return (
          <>
          <div className="research-container-card font-Poppins" style={{
            ...
            <div className="research-card-desc-container">
              ...
              Cooling and Cleaning System: Case Study at Al-Khobar
               City,” Processes, vol.
               8, no. 1, Article ID 9, 2020. 
              </div>
            </div>
  ...
  return (
    <div className="research-container section-container">
      ...
      <div className="btns-container">
        ...
        <MainButton functionality={() => handleTabClick("CONFERENCE PUBLICATIONS")} IsTab={true} isActive={selectedTab === "CONFERENCE PUBLICATIONS "}>
          CONFERENCE
        </MainButton>
        <MainButton functionality={() => handleTabClick("BOOK CHAPTER PUBLICATIONS")} IsTab={true} isActive={selectedTab === "BOOK CHAPTER PUBLICATIONS"}>
          BOOK CHAPTER
        </MainButton>
        <MainButton functionality={() => handleTabClick("OTHER PUBLICATIONS")} IsTab={true} isActive={selectedTab === "OTHER PUBLICATIONS "}>
          OTHER
        </MainButton>
      </div>
